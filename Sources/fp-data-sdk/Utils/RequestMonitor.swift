...
public  class RequestMonitor {
    ...
    public func processEvent(nucleusState: NucleusState, metadata: [String: Any]) {
        ...
        switch eventName {
            ...
            case "requestFailed":
            handleRequestFailed(metadata: metadata)
    ...
    public func handleRequestCompleted(metadata: [String: Any]) {
        ...
        let duration = responseEnd - (responseStart != 0 ? responseStart : (requestStart != 0 ? requestStart : 0))
    ...
    public func handleRequestFailed(metadata: [String: Any]) {
        self.requestCount += 1
